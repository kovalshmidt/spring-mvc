...
INSERT INTO users (id, name, surname, email, password, roles, phoneUser_id) VALUES (31, 'Stepan', 'Giga', 'giga@giga.com','$2a$10$y3/je8TF1.6zUq6Mh743M.e/1sHEC7nM.LCZsswTfyI5LhI3UAn6C', 'REGISTERED_USER', 1);
INSERT INTO users (id, name, surname, email, password, roles, phoneUser_id) VALUES (32, 'Viktor', 'Pavlik', 'pavlik@pavlik.com', '$2a$10$ul71VFDGhnTTNpV0OXAjFuvL8RGG3Wmxxyun/BEC1WIUVLI.dROcC', 'REGISTERED_USER', 2);
